...
defmodule PPNetTest do
  ...
  describe "encode PPNet.Message.Ping" do
    test "encode/1 with valid data" do
      ...
      assert PPNet.encode_message(message) ==
               <<0x06, 0x03, 0x99, 0xCB, 0x40, 0x39, 0x01, 0x01, 0x01, 0x01, 0x01, 0x02, 0xCE, 0x1D, 0x01, 0x86, 0xA0,
                 0x93, 0xCB, 0x40, 0x44, 0x5B, 0x3D, 0x6F, 0x56, 0xFA, 0xE4, 0xCB, 0xC0, 0x52, 0x80, 0x62, 0x81, 0x9A,
                 0x49, 0x6D, 0xCD, 0x27, 0x10, 0xCB, 0x3F, 0xE0, 0x01, 0x01, 0x01, 0x01, 0x01, 0x05, 0x32, 0x64, 0x92,
                 0xA7, 0x1F, 0x1A, 0x2B, 0x3C, 0x4D, 0x5E, 0xD6, 0xA7, 0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xC9, 0x92,
                 0xCD, 0x03, 0xE8, 0xCD, 0x01, 0xF4, 0x80, 0x10, 0x9B, 0xEE, 0xD7, 0xA4, 0x50, 0x5B, 0x40, 0x00>>
    end
    ...
    test "encode/1 with valid data and extra" do
      ...
      assert PPNet.encode_message(message) ==
               <<0x06, 0x03, 0x99, 0xCB, 0x40, 0x39, 0x01, 0x01, 0x01, 0x01, 0x01, 0x1D, 0xCD, 0x03, 0xE8, 0x93, 0xCB,
                 0x40, 0x44, 0x5B, 0x3D, 0x6F, 0x56, 0xFA, 0xE4, 0xCB, 0xC0, 0x52, 0x80, 0x62, 0x81, 0x9A, 0x49, 0x6D,
                 0xCD, 0x27, 0x10, 0xCB, 0x3F, 0xE0, 0x01, 0x01, 0x01, 0x01, 0x01, 0x21, 0x32, 0x64, 0x90, 0x92, 0xCD,
                 0x03, 0xE8, 0xCD, 0x01, 0xF4, 0x82, 0xA3, 0x62, 0x61, 0x7A, 0x7B, 0xA3, 0x66, 0x6F, 0x6F, 0xA3, 0x62,
                 0x61, 0x72, 0xC5, 0x02, 0x06, 0x8F, 0x44, 0x8A, 0x7B, 0xFC, 0x00>>
    end
